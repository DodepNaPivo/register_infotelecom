    ...
    registerForm.addEventListener('submit', function(e) {
        ...
        .then(data => {
            if (data.success) {
                ...
                successDiv.textContent = 'Регистрация успешна! Пользователь сохранен в базе данных. Вы будете перенаправлены в личный кабинет...';
        ...
        .catch(error => {
            ...
            if (error.message.includes('Failed to fetch') || error.message.includes('network')) {
                ...
                successDiv.textContent = 'Регистрация успешна (данные в браузере)! Для сохранения в БД настройте API. Вы будете перенаправлены в личный кабинет...';
                successDiv.style.display = 'block';
